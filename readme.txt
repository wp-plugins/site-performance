...
With this plugin you can measure the performance of your WordPress blog, no coding required, just install it and browse the pages.
...
1. Number of queries per page chart.
2. Memory usage per page chart.
3. Render time per page chart.
